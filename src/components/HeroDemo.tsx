...
export function HeroDemo() {
  ...
  const job = HERO_JOBS[activeJob];

  return (
    <section className="hero">
      <div className="hero-copy">
        <p className="eyebrow">A proactive agent for every HPE seller</p>
        ...
        <div className="hero-phone-jobs" aria-label="Choose a Grok Bot job">
          {HERO_JOBS.map((item, index) => (
            <button
              className={index === activeJob ? "is-active" : undefined}
              type="button"
              aria-pressed={index === activeJob}
